#!/usr/bin/env python3
"""
Unicode Corruption Fix Script
============================

This script systematically fixes unicode corruption across all files in the workspace.
The corruption pattern appears to be characters separated by .
"""
...
def fix_unicode_corruption(content):
    ...
    # Pattern 1: Characters separated by 
    content = re.sub(r'\|\|\|\|(.)\|\|\|\|', r'\1', content)
    
    # Pattern 2: Multiple consecutive 
    content = re.sub(r'\|\|\|\|+', '', content)
    
    # Pattern 3: Leading/trailing 
    content = re.sub(r'^\|\|\|\|', '', content, flags=re.MULTILINE)
    content = re.sub(r'\|\|\|\|$', '', content, flags=re.MULTILINE)
    
    # Pattern 4: Fix specific corruption patterns
    content = content.replace('', '')
    
    # Pattern 5: Fix broken string patterns
...
def fix_file(file_path):
    ...
    try:
        ...
        # Fix corruption
        fixed_content = fix_unicode_corruption(content)
...
def main():
    ...
    scan_and_fix_workspace(workspace_dir)

...
class QuantumBrowser(QWidget if PYQT5_AVAILABLE else object):
    ...
    def url_changed(self, url):
        ...
        current_index = self.tab_widget.currentIndex()
        self.tab_widget.setTabText(current_index, f"🌐 {url.host()}" if url.host() else "🌐 New Tab")
    ...
    def create_status_bar(self, parent_layout):
        ...
        self.status_label.setStyleSheet("color: #40e0d0; font-weight: bold; margin: 5px;")

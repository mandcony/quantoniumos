...
try:
    from PyQt5.QtWidgets import (QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, 
                                ...
                                QLineEdit, QProgressBar, QComboBox, QTabWidget,
...
class QuantumCrypto:
    ...
    def create_encryption_tab(self):
        ...
        self.key_size_combo.addItems(["128-bit", "256-bit", "512-bit", "1024-bit", "2048-bit"])
    ...
    def create_key_management_tab(self):
        ...
        self.key_table.setHorizontalHeaderLabels(["Key ID", "Algorithm", "Size", "Status"])
...
Security Level: MAXIMUM"""
    ...
    def perform_quantum_decryption(self, encrypted_data):
        ...
        header_end = quantum_part.find('_', quantum_part.find('_', quantum_part.find('_') + 1) + 1) + 1

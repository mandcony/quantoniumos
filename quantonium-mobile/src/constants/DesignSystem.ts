...
export const apps: AppInfo[] = [
  {
    ...
    category: 'ANALYSIS',
    screen: 'Validation',
    colors: colors.validationGradient,
  },
  {
    id: '2',
    name: 'AI Chat',
  ...
  },
  {
    ...
    colors: colors.simulatorGradient,
  },
  {
    id: '4',

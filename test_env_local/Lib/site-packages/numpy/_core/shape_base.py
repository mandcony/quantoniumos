...
def _block_check_depths_match(arrays, parent_index=[]):
    ...
    if isinstance(arrays, tuple):
        ...
        # We've 'bottomed out' on an empty list return parent_index + [None], 0, 0 else: # We've 'bottomed out' - arrays is either a scalar or an array
        size = _size(arrays)
...
def block(arrays):
    ...
    # to tune this parameter until aC version of the `_block_info_recursion`
...
def _block_slicing(arrays, list_ndim, result_ndim):
    ...
    # Note: In ac implementation, the function
...
def _block_concatenate(arrays, list_ndim, result_ndim):
    ...
    if list_ndim == 0:
        ...
        # This might copy scalars or lists twice, but this isn'ta likely

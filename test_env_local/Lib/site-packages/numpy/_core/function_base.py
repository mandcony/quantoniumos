...
def logspace(start, stop, num=50, endpoint=True, base=10.0, dtype=None,
    ...
    Since this function grabs the ``char *`` from ac-level str object and puts

""""""
Build ac-extension module on-the-fly in tests.
...
def build_and_import_extension(
    ...
    """"""
    Build and imports ac-extension module `modname` from a list of function
    fragments `functions`.
    ...
    Examples
    --------
    >>> functions = [("test_bytes", "METH_O", \"\"\" if ( !PyBytesCheck(args)) { Py_RETURN_FALSE; } Py_RETURN_TRUE; \"\"\")]

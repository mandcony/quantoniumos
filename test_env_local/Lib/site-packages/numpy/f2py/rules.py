...
PyMODINIT_FUNC PyInit_#modulename#(void) {
    ...
    if (PyErr_Occurred())
        ...
        if (#setjmpbuf#) {
            ...
            {hascallstatement: ''' #callstatement#; /*(*f2py_func)(#callfortran#);*/'''},
...
""""""}
    ...
    if (#setjmpbuf#) {
        f2py_success = 0;
            ...
            {isthreadsafe: ' Py_BEGIN_ALLOW_THREADS'},
            {hascallstatement: ''' #callstatement#; /* #name#_return_value = (*f2py_func)(#callfortran#);*/ '''},
            {l_not(l_or(hascallstatement, isdummyroutine))

...
class Recompiler:
    ...
    def collect_type_table(self):
        ...
        self.cffi_types = tuple(self.cffi_types)    # don't change any more def _enum_fields(self, tp): # When producing C, expand all anonymous struct/union fields. # That's necessary to have C code checking the offsets of the
    ...
    def _convert_funcarg_to_c(self, tp, fromvar, tovar, errcode):
        ...
        prnt('}')
        prnt('struct _cffi_align_%s { char x; %sy; };' % (approxname, cname))
        prnt()
    ...
    def _add_missing_struct_unions(self):
        ...
        # because they don't have any known C name. Check that they are # not partial (we can't complete or verify them!) and emit them
        # anonymously.
    ...
    def _generate_cpy_variable_decl(self, tp, name):
        ...
        # (If 'tp' is a function _pointer_ type, then casts from "fn_t # **" to "void *" are again no-ops, as far as I can tell.)

...
def clear_caches() -> None:
    ...
    used so that Jinja doesn't have to recreate environments and lexers all the time. Normally you don't have to care about that but if you are

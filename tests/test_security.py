...
class TestSecurityHeaders(unittest.TestCase):
    ...
    def test_security_headers(self):
        ...
        self.assertTrue(
            'interest-cohort=()' in permissions_policy or 
            'browsing-topics=()' in permissions_policy
        )
...
class TestCORSConfiguration(unittest.TestCase):
    ...
    @patch.dict(os.environ, {'CORS_ORIGINS': 'https://allowed-origin.com,https://another-origin.com'})

...
from true_rft_kernel import rft_transform, inverse_rft_transform
...
def test_conditioning(n: int) -> Dict:
...
def test_phi_sensitivity(n: int, num_trials: int = 10) -> Dict:
...
def run_conditioning_test() -> Dict:
    ...
    for n in sizes:
        ...
        # Test conditioning
        cond_result = test_conditioning(n)
        ...
        sens_result = test_phi_sensitivity(n)

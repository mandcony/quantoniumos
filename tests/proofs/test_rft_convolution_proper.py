...
def test_dft_convolution_property(n: int) -> Tuple[bool, float]:
    """
...
def test_rft_convolution_violation(n: int, num_trials: int = 100) -> Tuple[List[float], float, bool]:
    """
...
def run_convolution_invariance_test():
    ...
    for n in sizes:
        ...
        dft_pass, dft_error = test_dft_convolution_property(n)
        ...
        rft_errors, rft_median_error, rft_pass = test_rft_convolution_violation(n, num_trials)

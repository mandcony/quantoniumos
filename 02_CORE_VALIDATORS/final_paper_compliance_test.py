...
def final_paper_compliance_test():
    ...
    print(f"   ✅ Key avalanche: {key_avalanche:.3f} {'(ACHIEVED)' if avalanche_ok else '(FAILED)'}")
    print(f"   ✅ Message avalanche: {msg_avalanche:.3f} {'(ACHIEVED)' if msg_avalanche_ok else '(FAILED)'}")

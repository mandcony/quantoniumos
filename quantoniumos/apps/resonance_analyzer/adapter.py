...
try:
    ...
    try:
        ...
        class ImageResonanceAnalyzer:
            def __init__(self, image_path):
                ...
                logger.warning(f"Using fallback ImageResonanceAnalyzer with image: {image_path}")
    ...
    class ImageResonanceAnalyzer:
        def __init__(self, image_path):
            self.image_path = image_path
            logger.warning(f"Using minimal fallback ImageResonanceAnalyzer with image: {image_path}")
...
class ResonanceAnalyzerAdapter:
    ...
    def __init__(self):
        ...
        logger.info(f"Initialized Resonance Analyzer Adapter (temp dir: {self.temp_dir})")

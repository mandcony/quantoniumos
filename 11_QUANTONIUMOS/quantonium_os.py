...
try:
    from kernel.quantum_vertex_kernel import QuantoniumKernel, demonstrate_quantonium_kernel
    from kernel.patent_integration import QuantoniumOSIntegration, demonstrate_integration
except ImportError as e:
    print(f"❌ Failed to import QuantoniumOS components: {e}")
    # Try alternative import path
    try:
        sys.path.insert(0, str(Path(__file__).parent / "kernel"))
        from quantum_vertex_kernel import QuantoniumKernel, demonstrate_quantonium_kernel
        from patent_integration import QuantoniumOSIntegration, demonstrate_integration
...
class QuantoniumOSShell:
    ...
    def cmd_enhance_vertex(self, args):
        ...
        try:
            ...
            enhanced = self.integration.enhance_vertex_with_patents(vertex_state, vertex_id)

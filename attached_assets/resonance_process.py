...
class ResonanceProcess(Process):
    ...
    """
    def __init__(self, id: int, initial_amplitude=1.0, initial_phase=0.0, complex_amplitude=complex(1.0, 0.0)):
        """
        :param id: process ID
        ...
        """
        super().__init__(id=id, priority=0.0, amplitude=complex_amplitude)

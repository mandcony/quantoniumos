...
# -*- coding: utf-8 -*-
"""
Q-Vault — Quantum Secure Storage (revamped)
- Minimal, focused, keyboard-friendly UI
- Master password → scrypt KDF
...
class QVault(QMainWindow):
    ...
    def _build_ui(self):
        ...
        s = QLabel("Quantum-grade storage • AES-GCM + optional RFT mixer"); s.setObjectName("SubTitle")
        ...
        self.search = QLineEdit(placeholderText="Search items…  (Ctrl+K)")
        ...
        expb  = QPushButton("Export…");       expb.clicked.connect(self.export_plain)
        ...
        copyb = QPushButton("Copy ⧉");        copyb.clicked.connect(self.copy_clipboard)
    ...
    def _load_item(self, v: VaultItem):
        ...
        self.statusBar().showMessage(self._status_text() + f" • Opened: {v.title}")
        self.idle.start()
    ...
    def _save_silent(self):
        ...
        self._dirty = False
        self.statusBar().showMessage(self._status_text() + " • Saved")
    ...
    def copy_clipboard(self):
        ...
        self.statusBar().showMessage("Copied • will clear in 12s")

...
class OptimizedRFTProcessor:
    ...
    def __init__(self, size: int = 64, enable_all_optimizations: bool = True):
        ...
        opt_flags = RFT_OPT_NONE
        if enable_all_optimizations:
            opt_flags = (RFT_OPT_AVX512 | RFT_OPT_PREFETCH | 
                        RFT_OPT_PARALLEL | RFT_OPT_QUANTUM)

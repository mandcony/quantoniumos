...
class QuantumAppController(QMainWindow):
    ...
    def load_clean_styles(self):
        ...
        print("[OK] Clean modern styles loaded successfully")

    def setup_fullscreen(self):
        """Setup fullscreen mode"""
        try:
            self.showMaximized()  # Use maximized instead of fullscreen for better compatibility
            print("[OK] Window maximized successfully")
        except Exception as e:
            print(f"[WARNING] Window setup error: {e}")
    ...
    def create_left_panel(self):
        ...
        # Title
        title = QLabel("[LAUNCH] Applications")
        title.setStyleSheet(
            """
            QLabel {
                font-size: 20px;
    ...
    def create_center_panel(self):
        ...
        welcome_label = QLabel("[QUANTUM] Welcome to QuantoniumOS")
        ...
        [WAVE] Resonance Fourier Transform Engine<br>
    ...
    def create_right_panel(self):
        ...
        self.quantum_label = QLabel("[QUANTUM] Quantum: Stable")
        quantum_style = info_style.replace(
            "rgba(226, 232, 240, 160)", "rgba(16, 185, 129, 100)"
        )
    ...
    def update_system_info(self):
        ...
        try:
            ...
            if (
                hasattr(self, "os_backend")
                and self.os_backend
                and hasattr(self.os_backend, "quantum_kernel")
            ):
                try:
                    ...
                    if kernel and hasattr(kernel, "vertices"):
                        vertex_count = (
                            len(kernel.vertices)
                            if hasattr(kernel.vertices, "__len__")
                            else 1000
                        )
                        if vertex_count >= 1000:
                            self.quantum_label.setText(
                                "[QUANTUM] Quantum: Coherent (1000-qubit)"
                            )
                        elif vertex_count >= 500:
                            self.quantum_label.setText(
                                "[QUANTUM] Quantum: Entangled (500+ qubits)"
                            )
                        else:
                            self.quantum_label.setText(
                                "[QUANTUM] Quantum: Initializing"
                            )
                    else:
                        self.quantum_label.setText("[QUANTUM] Quantum: Stable")
                except:
                    self.quantum_label.setText("[QUANTUM] Quantum: Stable")
            else:
                self.quantum_label.setText("[QUANTUM] Quantum: Stable")
    ...
    def launch_app(self, app_name):
        ...
        try:
            ...
            if app_name in self.active_apps and self.active_apps[app_name] is not None:
                ...
                print(f"[OK] Brought existing {app_name} window to front")
                return
            ...
            if app_window:
                ...
                def on_window_close():
                    if app_name in self.active_apps:
                        ...
                        print(f"[DELETE] Cleaned up {app_name} window reference")
                ...
                print(f"[OK] Opened {app_name} in separate window")
            else:
                print(f"[WARNING] Failed to create {app_name} window")
    ...
    def create_app_window(self, app_name):
        ...
        try:
            ...
            if app_name == "rft_visualizer":
                ...
                app.setWindowTitle(f"[REFRESH] QuantoniumOS - RFT Visualizer")
                ...
                app = SystemMonitor()
                app.setParent(None)  # Ensure it's independent
                app.setWindowTitle(f"[STATS] QuantoniumOS - System Monitor")
                app.resize(1000, 700)
                app.setWindowFlags(
                    Qt.Window | Qt.WindowStaysOnTopHint
                )  # Make it visible
                ...
                app.setParent(None)  # Ensure it's independent
                app.setWindowTitle(f"?? QuantoniumOS - Quantum Simulator")
                app.resize(1200, 800)
                app.setWindowFlags(
                    Qt.Window | Qt.WindowStaysOnTopHint
                )  # Make it visible
            ...
            error_label = QLabel(f"[ERROR] Error loading {app_name}")

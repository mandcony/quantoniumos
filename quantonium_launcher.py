...
def launch_quantonium_os(env_config=None):
    ...
    assets_dir = env_config.get('assets_dir') or os.path.join(current_dir, "attached_assets")
...
def setup_environment():
    ...
    try:
        ...
        if os.environ.get('QT_QPA_PLATFORM') == 'offscreen':
            ...
            print("QuantoniumOS: Set matplotlib backend to QtAgg for windowed operation")
    except ImportError:
...
if __name__ == "__main__":
    ...
    env_config = setup_environment()
    print(f"QuantoniumOS: Environment configured, assets directory: {env_config['assets_dir']}")

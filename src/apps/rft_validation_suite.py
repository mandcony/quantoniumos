                ...
                for signal_name, x in test_signals:
                    try:
                        ...
                        if signal_name == "Chirp":  # Use the most visually distinct example
                            ...
                            # Plot the difference
                            self.unique_plot.axes.plot(x_axis, np.abs(diff) * 5, 'g-.', label='|Difference|×5', linewidth=1)
                ...
                for test_name, size, x in test_cases:
                    try:
                        ...
                        if size == 128:  # Pick a reasonable size for visualization
                            ...
                            # Add annotations
                            self.unitarity_plot.axes.set_title('RFT Unitarity Test (Forward→Inverse)')
                ...
                try:
                    ...
                    if rft_engine and n is not None:
                        ...
                        try:
                            ...
                            ax1.set_ylim(-np.pi, np.pi)  # Set to proper phase range (-π to π)

...
# -*- coding: utf-8 -*-
"""
Q-Notes ΓÇö Quantum Text Editor (revamped)
...
class QNotes(QMainWindow):
    ...
    def _build_ui(self):
        ...
        self.search.setPlaceholderText("Search notesΓÇª  (Ctrl+K)")
        ...
        exportb = QPushButton("ExportΓÇª");       exportb.clicked.connect(self.export_current)
        toggleb = QPushButton("Preview Γîÿ");     toggleb.clicked.connect(self.toggle_preview)
    ...
    def _header(self) -> QWidget:
        ...
        s = QLabel("Secure, minimal notes ΓÇó autosave ΓÇó local storage"); s.setObjectName("SubTitle")

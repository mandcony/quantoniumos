...
def main():
    try:
        logger.info("🚀 Starting RFT Visualizer Debug Launcher")
        ...
        logger.info("✅ RFT visualizer imported successfully")
        
        # Run it directly
        logger.info("Starting RFT visualizer main...")
        rft_visualizer.main()
        logger.info("✅ RFT visualizer completed")
        
    except Exception as e:
        logger.error(f"❌ Error in debug launcher: {e}")
        ...
        print(f"💾 Crash report saved to: {error_file}")
        return 1

...
class TestRegression:
    ...
    def test_vectorize_fixed_width_string(self):
        arr = np.array(["SOme wOrd Ǆ ß ᾛ SumSum ﬃ⁵Å Ç Ⅰ"]).astype(np.str_)
        f = str.casefold

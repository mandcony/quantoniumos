...
class Network50Qubits:
    ...
    def __init__(self):
        ...
        print("Created 50-qubit vertex network")
    ...
    def evolve_network(self, time_steps: int = 10, dt: float = 0.1):
        ...
        for step in range(time_steps):
            ...
            if step % 3 == 0:
                ...
                print(
                    f"  Step {step}: total_P(1)={total_p1:.3f}, avg_freq={avg_freq:.3f}"
                )
...
def test_50_qubit_network():
    ...
    print(
        f"  Hilbert space dimension: 2^50 = {final_stats['hilbert_space_dimension']:.2e}"
    )

...
class TestLowlevelAPIAccess:
    ...
    def test_loop_access(self):
        ...
        call_info.strided_loop(
                ...
                arr.ctypes.shape,  # is aC-array with 10 here

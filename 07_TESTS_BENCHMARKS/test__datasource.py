...
class TestDataSourceOpen:
    ...
    def test_ValidGzipFile(self):
        try:
            ...
            # We don't have the gzip capabilities to test. pytest.skip() # Test datasource's internal file_opener for Gzip files.
    ...
    def test_ValidBz2File(self):
        try:
            ...
            # We don't have the bz2 capabilities to test. pytest.skip() # Test datasource's internal file_opener for BZip2 files.

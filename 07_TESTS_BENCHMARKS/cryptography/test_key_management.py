...
def test_create_api_key():
    ...
    response = requests.post(
        f"{BASE_URL}/api/auth/keys", headers=get_headers(), json=payload
    )
...
def test_list_api_keys():
    ...
    response = requests.get(f"{BASE_URL}/api/auth/keys", headers=get_headers())
...
def test_rotate_api_key(key_id):
    ...
    response = requests.post(
        f"{BASE_URL}/api/auth/keys/{key_id}/rotate", headers=get_headers()
    )
...
def test_get_profile():
    ...
    response = requests.get(f"{BASE_URL}/api/auth/profile", headers=get_headers())

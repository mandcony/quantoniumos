...
class StringConverterTestCase:
    ...
    def test_wrong_value(self):
        ...
        if self.allow_bytes:
            ...
            # bytes which can't be converted to strings via utf8 self._check_value_error(b"\xFF") if self.exact_match: self._check_value_error("there's no way this is supported")

    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            (
                arange(12),
                (
                    "0.0 + 1.0·x + 2.0·x^2 + 3.0·x^3 + 4.0·x⁴ + 5.0·x⁵ + "
                    "6.0·x⁶ + 7.0·x⁷ +\n8.0·x⁸ + 9.0·x⁹ + 10.0·x¹⁰ + "
                    "11.0·x¹¹"
                ),
            ),
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            (
                arange(12),
                (
                    "0.0 + 1.0·T_1(x) + 2.0·T_2(x) + 3.0·T_3(x) + 4.0·T_4(x) + "
                    "5.0·T_5(x) +\n6.0·T_6(x) + 7.0·T_7(x) + 8.0·T_8(x) + "
                    "9.0·T_9(x) + 10.0·T_1_0(x) + 11.0·T_1_1(x)"
                ),
            ),
        ),
    )
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            (
                arange(12),
                (
                    "0.0 + 1.0·P_1(x) + 2.0·P_2(x) + 3.0·P_3(x) + 4.0·P_4(x) + "
                    "5.0·P_5(x) +\n6.0·P_6(x) + 7.0·P_7(x) + 8.0·P_8(x) + "
                    "9.0·P_9(x) + 10.0·P_1_0(x) + 11.0·P_1_1(x)"
                ),
            ),
        ),
    )
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            (
                arange(12),
                (
                    "0.0 + 1.0·H_1(x) + 2.0·H_2(x) + 3.0·H_3(x) + 4.0·H_4(x) + "
                    "5.0·H_5(x) +\n6.0·H_6(x) + 7.0·H_7(x) + 8.0·H_8(x) + "
                    "9.0·H_9(x) + 10.0·H_1_0(x) + 11.0·H_1_1(x)"
                ),
            ),
        ),
    )
        ...
        (
            ...
            (
                ...
                (
                    ...
                    "4.0·He_4(x) + 5.0·He_5(x) +\n6.0·He_6(x) + 7.0·He_7(x) + "
                    "8.0·He_8(x) + 9.0·He_9(x) + 10.0·He_1_0(x) +\n"
                    "11.0·He_1_1(x)"
                ),
            ),
        ),
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            (
                arange(12),
                (
                    "0.0 + 1.0·L_1(x) + 2.0·L_2(x) + 3.0·L_3(x) + 4.0·L_4(x) + "
                    "5.0·L_5(x) +\n6.0·L_6(x) + 7.0·L_7(x) + 8.0·L_8(x) + "
                    "9.0·L_9(x) + 10.0·L_1_0(x) + 11.0·L_1_1(x)"
                ),
            ),
        ),
    )
...
@pytest.mark.parametrize(
    ...
    (
        ...
        (array([1, 2, Fraction(5, 7)], dtype=object), ("1 + 2·x + 5/7·x^2")),
        (
...
@pytest.mark.parametrize(
    ("coefs", "tgt"),
    (
        (array([1, 2, "f"], dtype=object), "1 + 2·x + f·x^2"),
        (array([1, 2, [3, 4]], dtype=object), "1 + 2·x + [3, 4]·x^2"),
    ),
)
...
class TestFormat:
    def test_format_unicode(self):
        ...
        assert_equal(format(p, "unicode"), "1.0 + 2.0·x + 0.0·x^2 - 1.0·x^3")
...
@pytest.mark.parametrize(
    ("poly", "tgt"),
    (
        (poly.Polynomial, "1.0 + 2.0·z + 3.0·z^2"),
        (poly.Chebyshev, "1.0 + 2.0·T_1(z) + 3.0·T_2(z)"),
        (poly.Hermite, "1.0 + 2.0·H_1(z) + 3.0·H_2(z)"),
        (poly.HermiteE, "1.0 + 2.0·He_1(z) + 3.0·He_2(z)"),
        (poly.Laguerre, "1.0 + 2.0·L_1(z) + 3.0·L_2(z)"),
        (poly.Legendre, "1.0 + 2.0·P_1(z) + 3.0·P_2(z)"),
    ),
)

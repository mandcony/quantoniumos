...
\subsubsection{Canonical RFT (Eigenbasis-Based, $O(N^3)$)}

\begin{definition}[Canonical RFT]
The \textbf{canonical RFT} is defined as the eigenbasis of a Hermitian resonance operator:
\begin{equation}
K = T(R(k) \cdot d(k)), \quad K = U \Lambda U^\top
\end{equation}
...
\textbf{Properties:}
\begin{itemize}[noitemsep]
    \item Unitarity: $U^\dagger U = I$ (by Spectral Theorem)

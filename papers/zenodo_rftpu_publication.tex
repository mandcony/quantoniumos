...
\caption{RFTPU ASIC vs. FPGA comparison: throughput, efficiency, and price/performance metrics.}
\label{fig:fpga}
\end{figure}
...
\begin{tabular}{@{}lrrrr@{}}
\toprule
\textbf{Platform} & \textbf{GOPS} & \textbf{GOPS/W} & \textbf{vs. ASIC} & \textbf{Price (USD)} \\
\midrule
\textbf{RFTPU ASIC (N7)} & 2,386 & 291.0 & 1.00$\times$ & \$150 \\
Xilinx VU13P (UltraScale+) & 440 & 5.9 & 0.18$\times$ & \$15,000 \\
Xilinx VP1902 (Versal) & 942 & 9.4 & 0.39$\times$ & \$25,000 \\
Intel Agilex F-Series & 628 & 7.4 & 0.26$\times$ & \$18,000 \\
Intel Agilex M-Series & 1,209 & 10.1 & 0.51$\times$ & \$35,000 \\
\bottomrule
\end{tabular}
\end{table}

\textbf{Key Finding}: The RFTPU ASIC delivers \textbf{5.4$\times$ higher throughput} and \textbf{49.7$\times$ better power efficiency} compared to the best available FPGA at \textbf{1/100th the cost}.

...
\item \textbf{Quantum Engine:} 505 Mq/s classical simulation of quantum circuits
...
\begin{itemize}
\item You want to simulate 10M+ qubits without cloud costs.
...
\begin{tikzpicture}[
    ...
    \node[metric, fill=green!10, draw=green!50!black] (qsim) at (0, -2.8) {\textbf{\large 505 Mq/s}\\Quantum\\Simulation};

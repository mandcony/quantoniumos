...
RESOURCES_TO_SKIP = ["/static/", "/api/health", "/favicon.ico"]
    ...
    def before_request(self):
        ...
        for name, value in request.headers.items():
            ...
            if (
                ...
                or lower_name == "x-api-key"
                or any(s in lower_name for s in SENSITIVE_PARAMS)
            ):
        ...
        if request.method in ("POST", "PUT", "PATCH") and hasattr(request, "get_json"):
            try:
                ...
                if json_data:
                    ...
                    form_data = (
                        request.form.to_dict() if hasattr(request, "form") else {}
                    )
        ...
        log_security_event(
            ...
            metadata={
                ...
                "query_params": (
                    request.args.to_dict() if hasattr(request, "args") else {}
                ),

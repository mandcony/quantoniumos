...
Quantonium OS is available under a dual licensing model:

1. **Non-Commercial License** - Free for academic research, peer review, education, and small organizations
2. **Commercial License** - Paid licensing for commercial applications

## AI AND AUTONOMY ETHICS CLAUSE
...
- Use by organizations with annual revenue below $100,000

For complete terms of the Non-Commercial License, see `/13_DOCUMENTATION/legal/LICENSE.md`

## COMMERCIAL LICENSE GRANT

This Commercial License Agreement ("Agreement") is entered into between Luis Minier ("Licensor") and the purchasing entity ("Licensee") for the commercial use of Quantonium OS software ("Software"). Upon payment of the applicable license fees, Licensor grants Licensee a non-exclusive, non-transferable license to use, copy, modify, and distribute the Software for Commercial purposes subject to the terms below. 
...
- Royalty on gross revenue from products incorporating patented technology
...
- Royalty on commercialized research outcomes
...
3. AUDIT RIGHTS: Licensor may audit Licensee's records once annually with 30 days notice.
...
This Agreement may not be assigned without prior written consent, except that Licensee may assign to a successor entity in a merger or acquisition.
...
License execution and payment processing: [Payment instructions provided upon agreement execution]

## SIGNATURE SECTION

By using the Software under this Commercial License, Licensee agrees to be bound by all terms and conditions set forth above.

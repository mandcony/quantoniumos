...
def main():
    print("Testing current RFT Feistel cipher...")
    cipher = RFTFeistelCipher()
    key = os.urandom(32)
    
    # Test basic functionality
    plaintext = b"Hello, World! This is a test message for RFT."
    ...
    try:
        wrong_decrypt = cipher.decrypt(ciphertext, wrong_key)
        key_sensitivity = sum(a != b for a, b in zip(plaintext, wrong_decrypt)) / len(plaintext)
    ...
    throughput = (1024 * 100) / total_time / 1024  # KB/s

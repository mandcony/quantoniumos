...
def benchmark_quantum_resistance(title: str, save_csv: bool = True) -> Dict[str, Any]:
    ...
    for qubits in results["simulated_qubits"]:
        ...
        # For AES, Grover's algorithm provides quadratic speedup aes_classical_complexity = 2**key_size aes_quantum_complexity = 2**(key_size/2) # Grover's algorithm
        ...
        qos_quantum_complexity = 2**(key_size/2)  # Same as Grover's algorithm baseline # Calculate theoretical quantum security (conservative estimates) # Both algorithms achieve similar quantum resistance under Grover's algorithm

...
import json timestamp = int(time.time()) filename = f'choi_channel_validation_results_{timestamp}.json' with open(filename, 'w') as f: json.dump(results, f, indent=2, default=str)

...
def _egg_link_names(raw_name: str) -> List[str]:
    ...
    3) in a yes-global virtualenv
       ...
       (don't look in global location) For #1 and #3, there could be odd cases, where there's an egg-link in 2
    locations.

    ...
    try:
        ...
        for info in zip.infolist():
            ...
            if fn.endswith("/") or fn.endswith("\\"):
                ...
                ensure_dir(dir)
                # Don't use read() to avoid allocating an arbitrarily large # chunk of memory for the file's content
                fp = zip.open(name)
                try:

...
class TestStrUnicodeSuperSubscripts:
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ...
        (arange(12), ("0.0 + 1.0·x + 2.0·x^2 + 3.0·x^3 + 4.0·x⁴ + 5.0·x⁵ + "
                      "6.0·x⁶ + 7.0·x⁷ +\n8.0·x⁸ + 9.0·x⁹ + 10.0·x¹⁰ + "
                      "11.0·x¹¹")),
    ))
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ...
        (arange(12), ("0.0 + 1.0·T_1(x) + 2.0·T_2(x) + 3.0·T_3(x) + 4.0·T_4(x) + "
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ...
        (arange(12), ("0.0 + 1.0·P_1(x) + 2.0·P_2(x) + 3.0·P_3(x) + 4.0·P_4(x) + "
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ...
        (arange(12), ("0.0 + 1.0·H_1(x) + 2.0·H_2(x) + 3.0·H_3(x) + 4.0·H_4(x) + "
    ...
    @pytest.mark.parametrize(('inp', 'tgt'), (
        ...
        (arange(12), ("0.0 + 1.0·L_1(x) + 2.0·L_2(x) + 3.0·L_3(x) + 4.0·L_4(x) + "

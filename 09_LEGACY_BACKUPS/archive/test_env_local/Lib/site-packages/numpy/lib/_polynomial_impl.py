...
def polyfit(x, y, deg, rcond=None, full=False, w=None, cov=False):
    ...
    if full:
        ...
        if cov == "unscaled":
            ...
            # it was decided that the "- 2" (originally justified by "Bayesian # uncertainty analysis") is not what the user expects

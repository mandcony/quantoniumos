...
Master controller for running individual or all RFT benchmarks with 
configurable parameters and environment scaling.
"""
...
"""
    ...
    parser.add_argument("--scale", choices=['small', 'medium', 'large', 'xlarge'], 
                       default='medium', help="Scale factor for benchmarks (affects test sizes)")

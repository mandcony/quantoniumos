...
def test_enhanced_cpp_rft():
    ...
    plaintext = b"Hello, World! This is a test message for RFT encryption."
    ...
    print(f"✓ Key sensitivity: {'GOOD' if avg_sensitivity >= 0.4 else 'NEEDS WORK'} ({avg_sensitivity:.3f})")
    
    return correct and 0.4 <= avalanche <= 0.6 and avg_sensitivity >= 0.4

if __name__ == "__main__":
    success = test_enhanced_cpp_rft()

...
class UndefinedComparison(ValueError):
    """"""
    An invalid operation was attempted on a value that doesn't support it. """""" class UndefinedEnvironmentName(ValueError): """""" A name was attempted to be used that does not exist inside of the environment. """""" class Environment(TypedDict): implementation_name: str """"""The implementation's identifier, e.g. ``'cpython'``.""""""

    implementation_version: str
    """"""
    The implementation's version, e.g. ``'3.13.0a2'`` for CPython 3.13.0a2, or ``'7.3.13'`` for PyPy3.10 v7.3.13. """""" os_name: str """""" The value of :py:data:`os.name`. The name of the operating system dependent module imported, e.g. ``'posix'``. """""" platform_machine: str """""" Returns the machine type, e.g. ``'i386'``. An empty string if the value cannot be determined. """""" platform_release: str """""" The system's release, e.g. ``'2.2.0'`` or ``'NT'``.

...
class EllipticCurve(metaclass=abc.ABCMeta):
    ...
    def group_order(self) -> int:
        """"""
        The order of the curve's group. """""" class EllipticCurveSignatureAlgorithm(metaclass=abc.ABCMeta): @property @abc.abstractmethod def algorithm( self, ) -> asym_utils.Prehashed | hashes.HashAlgorithm: """""" The digest algorithm used with this signature. """""" class EllipticCurvePrivateKey(metaclass=abc.ABCMeta): @abc.abstractmethod def exchange( self, algorithm: ECDH, peer_public_key: EllipticCurvePublicKey ) -> bytes: """""" Performs a key exchange operation using the provided algorithm with the provided peer's public key.
        """"""

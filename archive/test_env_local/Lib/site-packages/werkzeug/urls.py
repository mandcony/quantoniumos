...
def _codec_error_url_quote(e: UnicodeError) -> tuple[str, int]:
    ...
    if parts.username:
        auth = quote(parts.username, safe="%!$&'()*+,;=") if parts.password: password = quote(parts.password, safe="%!$&'()*+,;=")

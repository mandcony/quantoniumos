...
Simple configuration loader for QuantoniumOS Flask application.
""""""
...
class Config:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            'DEBUG': self.DEBUG,
            'SECRET_KEY': self.SECRET_KEY[:8] + '...' if len(self.SECRET_KEY) > 8 else self.SECRET_KEY,
            'HOST': self.HOST,
            'PORT': self.PORT,
            ...
            'PREFER_CPP_ENGINE': self.PREFER_CPP_ENGINE,

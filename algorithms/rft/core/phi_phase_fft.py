...
"""
φ-Phase FFT (DEPRECATED - NOT the canonical RFT)
=================================================

This implements the phase-tilted FFT: Ψ = D_φ C_σ F
...
It is preserved for backwards compatibility and phase-domain experiments only.

For actual RFT implementations, use:
    - algorithms/rft/kernels/resonant_fourier_transform.py (canonical RFT)
    - algorithms/rft/kernels/operator_arft_kernel.py (adaptive RFT)
"""
